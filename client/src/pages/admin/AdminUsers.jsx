        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-zinc-400 font-medium tracking-tight">
              Manage customers and seller accounts.
            </p>
          </div>
        </div>
                      ...
                      >
                            ...
                            <div>
                              <p className="font-bold text-gray-900 dark:text-white capitalize group-hover:text-indigo-500 transition-colors">
                                ...
                                {user._id === currentUser?._id && (
                                  <span className="ml-2 text-[10px] bg-indigo-500/20 text-indigo-500 px-2 py-0.5 rounded-full uppercase tracking-widest leading-none align-middle">
                                    You
                                  </span>
                                )}
                              </p>
                        ...
                        <td className="py-4 px-4">
                          <select
                            ...
                            className={`text-xs font-black tracking-widest uppercase rounded-lg px-3 py-1.5 border-0 focus:ring-2 focus:ring-indigo-500/50 appearance-none cursor-pointer outline-none transition-all shadow-sm ${
                              user.role === "admin"
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            user.role !== "admin" ? (
                              <>
                                <button
                                  onClick={() =>
                                    handleBanToggle(user._id, user.status)
                                  }
                                ...
                                <button
                                  ...
                                  className="p-2 rounded-xl transition-all shadow-sm flex items-center justify-center bg-white dark:bg-zinc-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-white/10 hover:bg-red-50 dark:hover:bg-red-500/10 hover:text-red-500 hover:border-red-500/30"
                                  title="Delete User"
                                >
                                  <Trash2 size={18} />
                                </button>
