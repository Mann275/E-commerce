    ...
    <div className="pt-8 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-500 dark:text-zinc-400 font-medium tracking-tight">
          Monitor platform health, users, and overall operations.
        </p>
      </motion.div>
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="h-36 bg-gray-200 dark:bg-zinc-800/50 rounded-3xl animate-pulse backdrop-blur-xl border border-white/10"
            />
          ))}
        </div>
      ) : (
        ...
        >
          <motion.div
            ...
            className="bg-white/70 dark:bg-zinc-900/40 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-3xl p-6 shadow-sm flex items-center gap-6 group hover:border-indigo-500/50 transition-colors cursor-pointer"
          >
          ...
          <motion.div
            variants={itemVariants}
            onClick={() => navigate("/admin-dashboard/orders")}
            className="md:col-span-2 lg:col-span-2 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-white/10 rounded-3xl p-6 shadow-sm flex flex-col justify-center relative overflow-hidden group cursor-pointer hover:border-indigo-500/50 transition-colors"
          >
