...
function AdminProducts() {
  ...
  const handleDeleteProduct = async (productId) => {
    if (
      !window.confirm(
        "Are you sure you want to PERMANENTLY delete this product? This overrides seller ownership.",
      )
    )
      return;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-zinc-400 font-medium tracking-tight">
              Review and moderate all platform hardware listings.
            </p>
          </div>
        </div>
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="flex flex-col gap-1">
                            <span
                              className={`text-xs font-black uppercase tracking-widest px-2 py-0.5 rounded-md inline-block w-max ${
                                product.quantity > 10
                            ...
                            <span
                              className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-md inline-block w-max ${
