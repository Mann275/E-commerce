...
function AdminOrders() {
  ...
  const StatusBadge = ({ status }) => {
    ...
    const colorClass =
      colors[status] || "bg-gray-500/10 text-gray-500 border-gray-500/20";
    return (
      <span
        className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${colorClass}`}
      >
        {icons[status] || null}
        {status}
      </span>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight">
              Command{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-400 to-fuchsia-500 italic">
                Orders
              </span>
            </h1>
            <p className="text-gray-500 dark:text-zinc-400 font-medium tracking-tight">
              Oversee platform-wide logistics and transactions.
            </p>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200 dark:border-white/10">
                  <th className="py-4 px-4 text-xs font-black uppercase tracking-wider text-gray-500 dark:text-gray-400">
                    Transaction
                  </th>
                  <th className="py-4 px-4 text-xs font-black uppercase tracking-wider text-gray-500 dark:text-gray-400">
                    Customer
                  ...
                  <th className="py-4 px-4 text-xs font-black uppercase tracking-wider text-gray-500 dark:text-gray-400 text-right">
                    Actions
                  </th>
                </tr>
              </thead>
                ...
                <AnimatePresence>
                  {filteredOrders.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan="5"
                        className="py-12 text-center text-gray-500 dark:text-zinc-400 font-medium"
                      >
                          ...
                          <div>
                            ...
                            <p className="text-sm font-bold dark:text-white">
                              {viewOrder.shippingAddress?.phone ||
                                viewOrder.shippingAddress?.contact ||
                                "N/A"}
                            </p>
                          </div>
                        </div>
                ...
                <div>
                  ...
                  <div className="border border-gray-100 dark:border-white/5 rounded-2xl overflow-hidden shadow-sm">
                    {viewOrder.items?.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-gray-50/50 dark:bg-zinc-900/30 border-b border-gray-100 dark:border-white/5 last:border-0 hover:bg-white dark:hover:bg-black transition-colors"
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] uppercase font-black tracking-widest text-gray-500 mt-1">
                              ...
                              &times; ₹{item.price?.toLocaleString() || 0}
                            </p>
                          </div>
                        </div>
                        <div className="mt-4 sm:mt-0 text-right w-full sm:w-auto">
                          <p className="text-sm font-black text-transparent bg-clip-text bg-linear-to-r from-indigo-400 to-fuchsia-500 italic">
                            ₹
                            {(
                    ...
                    <div className="bg-gray-100 dark:bg-white/5 p-4 flex justify-between items-center sm:text-lg border-t-2 border-dashed border-gray-200 dark:border-white/10">
                      <span className="font-black uppercase tracking-widest text-xs text-gray-500 dark:text-gray-400">
                        Total Charged
                      </span>
                      <span className="font-black text-indigo-500 text-xl tracking-tight">
