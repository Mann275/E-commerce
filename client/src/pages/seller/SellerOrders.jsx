      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 text-black dark:text-white">
        <div>
          ...
          <p className="text-gray-500 dark:text-zinc-500 font-medium text-sm">
            Track and fulfill customer purchase requests.
          </p>
        </div>
                  ...
                  <React.Fragment key={o._id}>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`text-[9px] font-black uppercase tracking-widest inline-flex items-center gap-1.5 px-3 py-1 rounded-full ${o.orderStatus === "Cancelled" ? "bg-rose-500/10 text-rose-500" : "bg-sky-500/10 text-sky-500"}`}
                        >
                          <span
                            className={`w-1 h-1 rounded-full ${o.orderStatus === "Cancelled" ? "bg-rose-500" : "bg-sky-500"} ${o.orderStatus === "Processing" ? "animate-pulse" : ""}`}
                          />
                          {o.orderStatus}
                        </span>
                      </td>
                          ...
                          {o.orderStatus === "Pending" && (
                            <>
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleUpdateStatus(o._id, "Placed");
                                }}
                          ...
                          {o.orderStatus === "Processing" && (
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleUpdateStatus(o._id, "Shipped");
                                }}
                            ...
                            <div className="space-y-6">
                              <div className="bg-white dark:bg-zinc-900/50 border border-gray-100 dark:border-white/5 rounded-2xl p-4 shadow-sm">
                                ...
                                <div className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                                  <p className="font-bold text-gray-900 dark:text-white flex justify-between">
                                    ...
                                    <a
                                      href={`mailto:${o.shippingAddress?.email}`}
                                      className="text-sky-500 text-xs font-medium hover:underline"
                                    >
                                      {o.shippingAddress?.email}
                                    </a>
                                  </p>
                                  <p className="text-xs text-gray-500 pb-2 border-b border-gray-100 dark:border-white/5 mb-2">
                              ...
                              <div className="bg-white dark:bg-zinc-900/50 border border-gray-100 dark:border-white/5 rounded-2xl p-4 shadow-sm flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <div
                                    className={`w-10 h-10 rounded-xl flex items-center justify-center ${o.paymentMethod === "Online" ? "bg-indigo-500/10 text-indigo-500" : "bg-emerald-500/10 text-emerald-500"}`}
                                  >
                                ...
                                {o.transactionId && (
                                  <div className="text-right">
                                    ...
                                    <span className="text-xs font-mono text-gray-500 bg-gray-100 dark:bg-white/5 px-2 py-1 rounded">
                                      {o.transactionId}
                                    </span>
                                  </div>
                                )}
