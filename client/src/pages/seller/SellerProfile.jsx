  ...
  useEffect(() => {
    const fetchSellerData = async () => {
      ...
      try {
        ...
        let sellerInfo = null;
        try {
          const userRes = await apiClient.get(`/users/get-user/${id}`);
          ...
          console.log(
            "Could not fetch explicit user profile, falling back...",
            e,
          );
        }
        ...
        if (res.data.success) {
          ...
          if (
            ...
            typeof sellerProducts[0].userId === "object"
          ) {
            ...
            {products.length === 0 ? (
              <div className="bg-white dark:bg-zinc-950/50 rounded-3xl p-12 text-center border border-gray-200 dark:border-white/10">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                  This seller does not currently have any products published on
                  the marketplace.
                </p>
              </div>
            ) : (
