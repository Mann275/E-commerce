...
function Checkout() {
  ...
  const subtotal = cartItems.reduce(
    (sum, item) => sum + (item.finalPrice || item.productPrice) * item.quantity,
    0,
  );
    ...
    try {
      ...
      if (saveToProfile) {
        if (!selectedAddressId) {
          await apiClient.post(`/users/address`, {
        ...
        if (paymentMethod === "COD") {
          ...
          const options = {
            ...
            prefill: {
              ...
              email:
                shippingAddress.email || user?.email || "customer@example.com",
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black transition-colors duration-300 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-2 mb-8">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center text-sky-500 hover:text-sky-600 font-bold transition-colors w-max"
          >
                ...
                <div className="mb-8">
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-4 no-scrollbar">
                    {user.addresses.map((addr) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          <div
                            className={`w-2 h-2 rounded-full ${selectedAddressId === addr._id ? "bg-sky-500 animate-pulse" : "bg-gray-300 dark:bg-zinc-700"}`}
                          ></div>
                    ...
                    <div
                      ...
                      className="shrink-0 w-32 p-4 rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/10 hover:border-sky-500/50 flex flex-col items-center justify-center gap-2 cursor-pointer transition-colors group"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/5 rounded-xl px-4 py-3 text-sm font-bold dark:text-white focus:border-sky-500 outline-none"
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">
                ...
                <div className="md:col-span-2 space-y-1">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/5 rounded-xl px-4 py-3 text-sm font-bold dark:text-white focus:border-sky-500 outline-none h-24 resize-none"
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">
                ...
                <div className="md:col-span-2 mt-2">
                  <label className="flex items-center gap-3 cursor-pointer group w-max">
                    <div className="relative">
                      ...
                      <svg
                        className="absolute top-0 left-0 w-5 h-5 text-white scale-0 peer-checked:scale-100 transition-transform p-1"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="4"
                    ...
                    <span className="text-xs font-bold text-gray-500 dark:text-gray-400 group-hover:dark:text-white transition-colors">
            ...
            <div className="bg-white dark:bg-zinc-950 border border-blue-400/30 dark:border-blue-500/30 rounded-3xl p-6 md:p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {["COD", "Online"].map((method) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center ${paymentMethod === method ? "bg-sky-500 text-white" : "bg-gray-100 dark:bg-white/5 text-gray-400"}`}
                    >
                      {method === "COD" ? (
                        <Truck size={24} />
                      ) : (
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <span className="font-bold dark:text-white">
                      ₹
                      {(
                        (item.finalPrice || item.productPrice) * item.quantity
                      ).toLocaleString()}
                    </span>
                  </div>
                ))}
