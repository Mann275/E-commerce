...
function FilterSidebar({
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden lg:block w-72 flex-shrink-0 sticky top-24 h-[calc(100vh-6rem)] rounded-2xl bg-white dark:bg-zinc-950 border border-blue-400/30 dark:border-blue-500/30 overflow-hidden shadow-sm">
        <div className="w-full h-full flex flex-col pt-4 pb-10 px-6 overflow-y-auto custom-scrollbar">
          <div className="flex items-center justify-between mb-8">
            ...
            {(selectedCategories.length > 0 || priceRange.max < 500000 || priceRange.min > 0) && (
              <button
          ...
          <div className="mb-8 border-b border-blue-400/30 dark:border-blue-500/30 pb-6">
            ...
            >
              ...
              <ChevronDown
                size={18}
                className={`transition-transform duration-300 ${expandedSection.categories ? "rotate-180" : ""
                  }`}
              />
            </button>
              ...
              >
                {categories.map((cat) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${isSelected
        ...
        {isMobileOpen && (
          <div className="fixed inset-0 z-[60] lg:hidden">
            ...
            <motion.div
              ...
              className="absolute top-0 left-0 h-full w-[300px] max-w-[80vw]"
